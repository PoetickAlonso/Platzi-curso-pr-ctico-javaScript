let salarioGravado;
const tarifaMensual = [
    limiteInferior [ .01, 644.59, 4910.18, 9614.67, 11176.63, 13381.48, 26988.51, 42537.59, 81211.26, 108281.68, 324845.02] ,
    limiteSuperior [44.58, 5470.92, 9614.66, 11176.62, 13381.47, 26988.50, 42537.58, 81211.25, 108281.67, 0, 324845.01] ,
    cuotaFija  [0, 12.38, 321.26, 772.10, 1022.01, 1417.12, 4323.58, 7980.73, 19582.83, 28245.36, 101876.90] ,
    porCientoSobreExcedenteLi [.0192, .0640, .1088, .16, .1792, .2136, .2352, .30, .32, .34, .35]   
]
...
let result = excedenteSalario;

function porcentajeAplicable() {
